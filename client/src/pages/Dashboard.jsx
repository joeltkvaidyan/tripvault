...
import { getTrips, createTrip, updateTrip, deleteTrip, uploadTripPhoto } from '../api/trips';
...
function Dashboard() {
  ...
  const handleFormSubmit = async (payload, photoFile) => {
    setFormSubmitting(true);
    setFormError('');
    try {
      let tripId;
      if (formMode === 'edit' && editingTrip) {
        const res = await updateTrip(editingTrip._id, payload);
      ...
      // Trip must exist before a photo can be attached to it
      if (photoFile) {
        await uploadTripPhoto(tripId, photoFile);
      }
    ...
    <div style={styles.page}>
      <header style={styles.header}>
        ...
        <div style={styles.headerActions}>
          ...
          <button onClick={openProfileForm} style={styles.editProfileButton}>
            Edit Profile
          </button>
